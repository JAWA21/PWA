...
var fighter1 = ['Hulk', 50, 100];
var fighter2 = ['Iron Man', 50, 100];

//Player Name
var playerOneName = fighter1[0];
var playerTwoName = fighter2[0];

//Player Health
var  playerOneHealth = fighter1[2];
var  playerTwoHealth = fighter2[2];

//Player Damage
var playerOneDamage = fighter1[1];
var playerTwoDamage = fighter2[1]; 
