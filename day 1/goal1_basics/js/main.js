...
console.log('------ strings ----------');
    ...
    //basic string
    var name = "James"
    console.log("phrase 1: ", name)

    //string w/ escape characters " \ "
    var phrase = "I need \"quotes\" to be here."
    console.log("phrase 2: ", phrase)

    //string w/ escape characters and mixed single quote
 ...
 ********************************************/
    ...
    console.log("sum of array: ", myArr[0] + myArr[1] + myArr[2] + myArr[3]);
 ...
 ********************************************/
 ...
 console.log("Activity 2: ", myArray[0] + "," + myArray[1] + "," + myArray[2]);
 ...
 */
    ...
    if(a === a){
        ...
        console.log("nested conditional: 1 st IF returned False")
    }
 ...
 */
    ...
    if((1 === 1) && ("hi" === "hi")){
        console.log('&& logics of both sides = true ');
    }

    if((1 === 1) || ("hi" === "no")){
        console.log('or logics = true')
    }
