...
chgAttr.setAttribute('href', 'http://www.google.com');
chgAttr.setAttribute('title', 'Some cool stuff!');
...
for(var i=0, max = navLinks.length; i<max; i++){
	...
	navLinks[i].style.border = '3px dotted yellow';
}
...
*/
	...
	var str = 'my personal email is es@gmail.com by my school email is es@fullsail.com and work email is es@yahoo.com';
	console.log(emailRegEx.exec(str));

	console.log(str.search(emailRegEx)); //position of first letter of the matching string
...
//create an arry of student objects. demonstrate = add a new student objects to the array of student 
//then use dom to ouput the student info using innerHTML
})(); // end wrapper